...
public class FlyingBishopTest {
    ...
    public void testGetPossibleMovesGeneralCaseWhite() {
        ...
        Piece piece = new FlyingBishop(color);
    ...
    public void testGetPossibleMovesPieceToTakeWhite() {
        ...
        Piece opponentPiece = new FlyingBishop(opponentColor);
    ...
    public void testGetPossibleMovesWhitePieceWhite() {
        ...
        Piece piece2 = new FlyingBishop(color);
    ...
    @Test
    public void testGetPossibleMovesBlackPieceBlack() {
        Color color = Color.BLACK;
        Piece piece = new FlyingBishop(color);
        List<Position> positions;
        List<Position> expected = new ArrayList<>();
